...
<manifest>
  ...
  <project name="ADeadTrousers/android_device_Unihertz_Atom_XL" path="device/Unihertz/Atom_XL" remote="github" revision="lineage-19.1" />
  <!-- For the Atom L region eea add -->  
  <project name="ADeadTrousers/android_device_Unihertz_Atom_L_EEA" path="device/Unihertz/Atom_L_EEA" remote="github" revision="lineage-19.1" />
  <!-- For the Atom XL region eea add -->  
  <project name="ADeadTrousers/android_device_Unihertz_Atom_XL_EEA" path="device/Unihertz/Atom_XL_EEA" remote="github" revision="lineage-19.1" />
  <!-- For the Atom L region tee add -->  
  <project name="ADeadTrousers/android_device_Unihertz_Atom_L_TEE" path="device/Unihertz/Atom_L_TEE" remote="github" revision="lineage-19.1" />
  <!-- For the Atom XL region tee add -->  
  <project name="ADeadTrousers/android_device_Unihertz_Atom_XL_TEE" path="device/Unihertz/Atom_XL_TEE" remote="github" revision="lineage-19.1" />
</manifest>
```
